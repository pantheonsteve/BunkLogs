...
def custom_google_login(request):
    ...
    try:
        ...
        return HttpResponse(f"Error initiating Google login: {e!s}")
    ...
    if request.user.is_authenticated:
        ...
        try:
            ...
            redirect_url = (
                ...
                f"#access_token={refresh.access_token!s}"
                f"&refresh_token={refresh!s}"
                f"&token_type=Bearer"
            )
            ...
            logger.exception(f"Error generating tokens: {e!s}")
