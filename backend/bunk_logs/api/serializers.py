...
class UnitSerializer(serializers.ModelSerializer):
    ...
    def get_unit_head_details(self, obj) -> dict[str, Any] | None:
    ...
    @extend_schema_field(OpenApiTypes.OBJECT)
    def get_camper_care_details(self, obj) -> dict[str, Any] | None:
...
class SimpleUnitSerializer(serializers.ModelSerializer):
    ...
    @extend_schema_field(OpenApiTypes.OBJECT)
    def get_unit_head(self, obj) -> dict[str, Any] | None:
    ...
    @extend_schema_field(OpenApiTypes.OBJECT)
    def get_camper_care(self, obj) -> dict[str, Any] | None:
...
class ApiUserSerializer(serializers.ModelSerializer):
    ...
    @extend_schema_field(OpenApiTypes.OBJECT)
    def get_unit(self, obj) -> dict[str, Any] | None:
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    def validate_order_items(self, value):
        ...
        if value is not None:
            if not value:
                msg = "At least one order item is required."
                raise serializers.ValidationError(msg)

            for item_data in value:
                if item_data.get("item_quantity", 0) <= 0:
                    msg = "Item quantity must be greater than 0."
                    raise serializers.ValidationError(msg)
...
class UnitBunkDetailSerializer(serializers.ModelSerializer):
    ...
    def get_campers(self, obj):
        ...
        if has_filters:
            ...
            return [camper for camper in camper_data if camper.get("bunk_log") is not None]
