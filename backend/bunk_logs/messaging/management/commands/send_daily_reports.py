...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"Error generating report data: {e!s}"))
            logger.error(f"Error generating report data: {e!s}", exc_info=True)
            return
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"Error rendering email template: {e!s}"))
            logger.error(f"Error rendering email template: {e!s}", exc_info=True)
            return
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"Error sending email: {e!s}"))
            logger.error(f"Error sending daily report email: {e!s}", exc_info=True)
