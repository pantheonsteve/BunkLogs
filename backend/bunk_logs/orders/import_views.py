...
from .forms import ItemCategoryImportForm
                ...
                try:
                    ...
                    if items_str:
                        ...
                        try:
                            ...
                            error_messages.append(f"Order {order.id}, Row {csv_reader.line_num}: Error processing items - {item_error!s}")

                    created_count += 1

                except Exception as e:
                    error_count += 1
                    error_messages.append(f"Row {csv_reader.line_num}: {e!s}")
