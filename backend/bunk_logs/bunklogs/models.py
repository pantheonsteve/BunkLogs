...
class BunkLog(TestDataMixin):
    ...
    def is_complete(self):
        ...
        return any(score is not None for score in [self.social_score, self.behavior_score, self.participation_score])
    ...
    def can_edit(self, user):
        ...
        return bool(user.has_perm("bunklogs.change_bunklog"))
    ...
    def clean(self):
        ...
        elif (self.social_score is None and
