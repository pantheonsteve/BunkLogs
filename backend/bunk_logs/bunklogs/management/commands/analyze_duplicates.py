    ...
    def analyze_bunklog_duplicates(self):
        ...
        if potential_issues:
            ...
            for issue in potential_issues:
                ...
                self.stdout.write("  CONFLICTS WITH:")
                ...
                if issue["description"] and issue["conflicting_description"]:
                    ...
                    if similarity > 0.8:
                        self.stdout.write("    ⚠️  HIGH SIMILARITY - Likely duplicate content")
                    elif similarity < 0.3:
                        self.stdout.write("    ✅ LOW SIMILARITY - Likely different legitimate logs")
                self.stdout.write("-" * 80)
        else:
