...
export default function MembershipTagsTab() {
  ...
  return (
    <div data-testid="membership-tags-tab">
      ...
      {!loading && !error && (
        <div className="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700" data-testid="membership-tags-table">
