...
function CamperLogsCamperViewItem(props) {
  ...
  return (
    <tbody className="text-sm divide-y divide-gray-100 dark:divide-gray-700/60">
      <tr>
        <td className="p-3 whitespace-wrap border border-gray-300 dark:border-gray-700">
        <Link 
        ...
        >
          <div>
            ...
            {/* Help request indicators below date */}
            <div className="flex flex-wrap gap-1 mt-1 justify-center">
              {props.request_camper_care_help && (
        ...
        {props.not_on_camp === true && (
          <td colSpan="4" className="px-12 first:pl-5 last:pr-5 py-3 whitespace-nowrap border border-gray-300 dark:border-gray-700">
